...
* 基本的に/bug setParam <パラメータ> <プレイヤー名> <値> で設定可能
  * breakblockLevelのみ /bug setParam <値> で設定可能
...
| breakMobTextureLevel | Mobのテクスチャをバグらせるパラメータ | 値が増えるごとにバグるMobが増える<br />* 1 ~ ： cow pig<br/>* 2 ~ ： chicken sheep<br/>* 3 ~ ： creeper zombie<br/>* 4 ~ ： spieder skeleton<br/>* 5 ~ ： blaze ghast<br/>* 6 ~ ： silverfish, endermite enderman<br/> | 0 ~ 6    |                          |
